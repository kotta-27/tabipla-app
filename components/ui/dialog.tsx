...
// Track open dialog count to handle nested dialogs correctly
let openCount = 0;
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        {...props}
      >
        {/* フォーカス吸収: ダイアログ開時に見えない要素を先にフォーカスさせ、ボタンへの ring 表示を防ぐ */}
        <span tabIndex={-1} aria-hidden="true" className="absolute opacity-0 pointer-events-none" />
        {children}
        {showCloseButton && (
