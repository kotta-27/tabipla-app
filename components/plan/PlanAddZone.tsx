      ...
      <>
        <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-800 min-h-[240px] gap-3">
          ...
          <div className="text-center">
            <p className="text-sm font-medium text-gray-400 dark:text-gray-300">まだプランがありません</p>
            <p className="text-xs text-gray-300 dark:text-gray-400 mt-1">右上のボタンから追加しましょう</p>
          </div>
        </div>
