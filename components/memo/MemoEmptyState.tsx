    ...
    <>
      ...
      >
        ...
        <div className="text-center">
          <p className="text-sm font-medium text-gray-400 dark:text-gray-400 group-hover:text-sky-500 transition-colors duration-150">まだメモがありません</p>
          <p className="text-xs text-gray-300 dark:text-gray-500 mt-1">クリックして最初のメモを追加しましょう</p>
        </div>
      </div>
